...
const GST = () => {
  ...
  return (
    <>
        <Head>
        <title>General Sales Taxes Calculator| [Website Name]</title>
        <meta name="description" content="General Sales Taxes Calculator" />
    ...
    <div class="finance calulator">
        <div class="finance-calculator">
            <h1>General Sales tax calculator</h1>
            <div>
